...
import { createSerializationAdapter, resolveManifestAssetLink, rootRouteId, createRawStreamRPCPlugin, invariant, isNotFound, isRedirect, isResolvedRedirect, executeRewriteInput, defaultSerovalPlugins, makeSerovalPlugin } from '@tanstack/router-core';
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import('../_/_tanstack-start-manifest_v-Bo4jKlrB.mjs');
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import('../_/router-B5VEdezp.mjs').then((n) => n.r),
    import('../_/start-HYkvq4Ni.mjs'),
    import('../_/__23tanstack-start-plugin-adapters-Cwee5PKy.mjs')
  ]);
  return {
    routerEntry,
    startEntry,
